...
def custom_args(args):
    ...
    args.exp_eval_every_n =1
    args.exp_eval_every_epoch_or_steps  = 'epochs'
    args.exp_optimizer_warmup_proportion =0.7
    args.exp_optimizer = 'lookahead_lamb'
    args.exp_azure_sweep =True
    args.metrics_auroc =False
    args.model_num_heads = 8
    args.model_stacking_depth = 8
    args.exp_lr = 1e-3
    args.exp_scheduler = 'flat_and_anneal'
    args.exp_num_total_steps = 500000
    args.exp_gradient_clipping = 1
    args.exp_batch_size = 512
    args.model_dim_hidden = 64
    args.model_augmentation_bert_mask_prob =dict(train=0.15, val=0, test=0)
    args.exp_tradeoff = 1
    args.exp_tradeoff_annealing ='cosine'
    args.model_checkpoint_key = 'mnist__dim_hidden_16__feature_mask__label_mask__linear'
    args.model_image_n_patches = 64
    args.model_image_patch_type = 'linear'
    args.model_image_n_channels = 3
    args.model_label_bert_mask_prob  = dict(train=0.15, val=0.0, test=0.0)
    args.model_image_n_classes = 10
    return args
